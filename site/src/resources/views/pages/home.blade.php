  ...
  <div class="grid grid-cols-12 gap-x-4 gap-y-4">
    ...
    <section class="col-span-12">
      ...
      <p>
        ...
        we post small
        "cookbooks", "cheat-sheets" and other general guides/annotations. These focus on things we've had to
        work/deal
        with in the past and would like to have an easy-to-follow guide in the future. Although editing of the wiki
        is
